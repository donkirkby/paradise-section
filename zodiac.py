...
class TangramDragon(Tangram):
    def __init__(self, scale=1, gap=0):
        ...
        self.p.flip()
        self.add(self.t1a)
        self.t1a.anchor(self.p, 0, 1)
        self.t1a.rotate(-180)
        self.add(self.s)
        self.s.anchor(self.t1a, 2)
        self.add(self.t1b)
        self.t1b.anchor(self.p, 1, 1)
        self.t1b.rotate(60)
        self.add(self.t4a)
        self.t4a.anchor(self.p, 1, 2)
        self.add(self.t4b)
        self.t4b.rotate(180)
        self.t4b.anchor(self.t4a, 1, 1)
        s = scale*self.ROOT2/4
        self.t4b.translate(-s, s)
        self.add(self.t2)
        self.t2.anchor(self.t4b, 2)
        self.t2.translate(0, -scale*self.ROOT2/8)
        self.rotate(10)
